...
call <SID>X("FoldColumn", s:darklilac, s:purps, "")
...
call <SID>X("SignColumn", s:darklilac, s:purps, "")
...
call <SID>X("StatusLineNC", s:amethyst, s:shadow, "reverse")
...
call <SID>X("TabLineFill", s:shadow, "", "")
call <SID>X("TabLineSel", s:linen, s:amethyst, "")
